...
6. 在报告中注明自己的创新点、特色等。
7. 提交：（1）本实验报告，（2）源代码压缩文件zip，（3）软件演示的MP4视频，视频大小不超过20M，视频请在搜狗浏览器测试能否正常播放。注意源代码加注释。注意文件名称的规范性。文件名：学号姓名1.docx，学号姓名1.zip, 学号姓名1.mp4。三个文件分别提交。
